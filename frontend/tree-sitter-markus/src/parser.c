...
static TSParseActionEntry ts_parse_actions[] = {
  ...
  [92] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_variable, 1, .production_id = 16),
  ...
  [110] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_action_declaration, 6, .production_id = 12),
  [112] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_type_declaration, 6, .production_id = 7),
  [114] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_type_declaration, 4, .production_id = 1),
  [116] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_type_declaration, 7, .production_id = 13),
  [118] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_uri, 1),
  [120] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_type_declaration, 5, .production_id = 3),
  [122] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_arguments, 2),
  [124] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_action_declaration, 5, .production_id = 6),
  ...
  [131] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_query_declaration, 5, .production_id = 5),
  [133] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_arguments, 4),
  [135] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_permission_declaration, 4, .production_id = 2),
  [137] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_action_declaration, 7, .production_id = 18),
  [139] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_arguments, 3),
  [141] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_query_declaration, 4, .production_id = 2),
  [143] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_call, 2, .production_id = 10),
  [145] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_action_declaration, 6, .production_id = 11),
  [147] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_update_statement, 4, .production_id = 21),
  ...
  [189] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_create_statement, 4, .production_id = 20),
  [191] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_guards_list, 1),
  [193] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_delete_statement, 3, .production_id = 17),
  ...
  [214] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_bases_list, 2),
  ...
  [237] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_bases_list_repeat1, 2),
  [239] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_bases_list_repeat1, 2), SHIFT_REPEAT(148),
  ...
  [253] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_bases_list, 1),
  ...
  [264] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_variable, 2, .production_id = 19),
  ...
  [279] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_binding, 3, .production_id = 22),
  ...
  [298] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_parameters_list, 4),
  [300] = {.entry = {.count = 1, .reusable = true}}, SHIFT(52),
  [302] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_binding, 2),
  [304] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_type_field, 4, .production_id = 14),
  [306] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_parameter, 4, .production_id = 15),
  [308] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_parameters_list, 5),
  [310] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_binding_field, 3, .production_id = 23),
  [312] = {.entry = {.count = 1, .reusable = true}}, SHIFT(111),
  [314] = {.entry = {.count = 1, .reusable = true}}, SHIFT(42),
  [316] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_parameter, 3, .production_id = 9),
  [318] = {.entry = {.count = 1, .reusable = true}}, SHIFT(43),
  [320] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_type_field, 3, .production_id = 8),
  [322] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_bases_list, 3),
  [324] = {.entry = {.count = 1, .reusable = true}}, SHIFT(71),
  [326] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_guard, 2, .production_id = 4),
  ...
  [336] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_parameters_list, 2),
  [338] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_parameters_list, 3),
